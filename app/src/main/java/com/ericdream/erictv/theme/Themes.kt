...
package com.ericdream.erictv.theme
...
private val TvDarkPalette = darkColors(
    primary = Blue200,
...
private val TvLightPalette = lightColors(
    primary = Blue500,
...
fun JetchatTheme(
    ...
    val myColors = colors ?: if (isDarkTheme) TvDarkPalette else TvLightPalette
